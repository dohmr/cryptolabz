    ...
    <div>
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          ...
          <p className="lead">Cryptolabs is a learning platform where users can read about the most popular cryptocurrencies, research the most recent market data, and test their knowledge in a personal practice investment portfolio</p>
        </div>
      </div>
      <Container fluid>
        <Row>
